...
namespace Proyecto_Crud
{
    public partial class MantenimientoPerson : Form
    {
        ...
        public void CargarDatos()
        {
            ...
            var Per = persona.ObtenerPorId(id_);

            // Asigna los datos de la persona a los campos de texto correspondientes
            text1.Text = Per.CompanyName;
            text2.Text = Per.ContactName;
            text3.Text = Per.ContactTitle;
            text4.Text = Per.City;
            text5.Text = Per.PostalCode;
            text6.Text = Per.Country;
            textBox7.Text = Per.Phone;
        }
